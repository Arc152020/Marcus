            ...
            <ResumeStyled>
                ...
                <InnerLayout>
                    ...
                    <div className="resume-content">
                            <ResumeItem 
                                year={'2020-present'} 
                                title={'C-STEMP Innovation Hub, Jos'}
                                subTitle={'IT Assistant/Facilitator'} 
                                text={'Designing and Coding of Apps, providing tech support for C-STEMP online platforms and facilitating digital skills training at the Jos Centre'}
                            />
